...
EXTERNAL_MONITOR="DP-3"                   # Your external display name
EXTERNAL_RESOLUTION="3840x2160@60"        # External monitor resolution@refresh
LAPTOP_RESOLUTION="2880x1920@120"          # Laptop monitor resolution@refresh
EXTERNAL_SCALE="2"                     # External monitor scaling factor
LAPTOP_SCALE="2"                           # Laptop monitor scaling factor
EXTERNAL_POSITION="0x0"                   # External monitor position
LAPTOP_POSITION_DUAL="0x1080"            # Laptop position in dual mode
